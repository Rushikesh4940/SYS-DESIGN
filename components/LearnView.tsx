          ...
          <div style="display:flex; flex-direction:column; gap: 1.5rem; margin-bottom: 3rem; padding: 2rem; background: var(--bg2); border: 1px solid var(--line); border-radius: 12px;">
            ...
            <div style="width:100%; display:flex; justify-content:center;">
              <svg width="240" height="140" viewBox="0 0 240 140">
                ...
                <text x="4" y="15" fill="var(--c2)" font-family="sans-serif" font-size="10" font-weight="bold" text-anchor="start">Direct Access</text>
        ...
        <div class="acc-text">
          ...
          <div style="display:flex; flex-direction:column; gap: 1.5rem; margin-bottom: 3rem; border: 1px solid var(--line); border-radius: 12px; padding: 2rem; background: var(--bg2);">
            <div style="flex: 1;">
              ...
              <p style="margin-top: 0.5rem;">Modules should be <b>Open For Extension</b>, but strictly <b>Closed For Modification</b>. You should be able to alter system behavior without tearing into the guts of existing, working code.<br><br><i>Beginner Analogy</i>: Imagine your code is a power strip. You don't carefully unscrew and rewire the internal chassis of the power strip just to plug in a new TV. You just plug the TV into an existing, defined socket (an Interface). We utilize polymorphism to let the system dynamically adopt new plugins!</p>
            </div>
            <div style="width:100%; display:flex; justify-content:center;">
              <svg width="240" height="120" viewBox="0 0 240 120">
                <!-- Base class (Locked) -->
          ...
          <div style="display:flex; flex-direction:column; gap: 1.5rem; margin-bottom: 3rem; border: 1px solid var(--line); border-radius: 12px; padding: 2rem; background: var(--bg2);">
            <div style="flex: 1;">
              ...
              <p style="margin-top: 0.5rem;">Wherever you use a base class, you must be able to securely substitute it with any derived child class without breaking the host application. A child must honor the exact contract guarantees of its parent.<br><br><i>Beginner Analogy</i>: If you write a generic <code>Bird</code> base class representing all birds, and it features a <code>fly()</code> method, you shouldn't create a <code>Penguin</code> subclass that randomly throws an error or crashes the app when <code>fly()</code> is called. That violates LSP and destroys the predictability of your pipeline!</p>
            </div>
            <div style="width:100%; display:flex; justify-content:center;">
              <svg width="240" height="100" viewBox="0 0 240 100">
          ...
          <div style="display:flex; flex-direction:column; gap: 1.5rem; margin-bottom: 3rem; border: 1px solid var(--line); border-radius: 12px; padding: 2rem; background: var(--bg2);">
            <div style="flex: 1;">
              ...
              <p style="margin-top: 0.5rem;">Smaller, laser-focused interfaces are vastly superior to massive global ones. Never force a client object to depend on or implement massive methods it doesn't even need to use.<br><br><i>Beginner Analogy</i>: Don't force a computer mouse component to implement an <code>outputVideo()</code> behavior just because both a mouse and a monitor plug into the same PC interface. Break a massive bloated <code>IMachine</code> interface down into hyper-specific <code>ICanClick</code> and <code>ICanDisplay</code> contracts.</p>
            </div>
            <div style="width:100%; display:flex; justify-content:center;">
              <svg width="240" height="100" viewBox="0 0 240 100">
